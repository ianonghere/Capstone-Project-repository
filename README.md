...
1.  **Python 3.12 (Recommended)**: The application requires Python 3.12 to ensure stability and compatibility with standard asynchronous frameworks, typing features, and modern dependency packages.
...
*   **Test Text Chunking & Parsing**:
    ```bash
    python -m app.core.test_parser
    ```
*   **Test API Endpoints & Database Lifecycle**:
    ```bash
    python -m app.core.test_api
    ```
